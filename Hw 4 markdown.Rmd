...
---
below is the code which will run descriptive statistics on the seletced flights file. 
...
the following plots show the variability for by month. The greater the distane the more variability 
